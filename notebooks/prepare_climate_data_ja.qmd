...
[English version](prepare_climate_data.qmd)
...
[`data/manual/mesh_climate_data_labels.csv`](../data/manual/mesh_climate_data_labels.csv)に、コードと対応する変数名を保存していますので、これをお使いください (クリックでダウンロードできます)。
